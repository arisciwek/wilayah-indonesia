 ...
 * @author      arisciwek
 *
 * Path: /wilayah-indonesia/assets/js/regency/regency-toast.js
 *
 ...
 */
 const RegencyToast = {
     ...
     init() {
         if (!this.container) {
             ...
             this.container.id = 'regency-toast-container';
     ...
     async processQueue() {
         ...
         // Create toast element with regency specific styling
         const toast = document.createElement('div');
         toast.className = `regency-toast regency-toast-${type}`;
     ...
     getToastStyles(type) {
         ...
         // Different colors for regency toasts
         const colors = {
             success: '#218838', // Darker green for regency
             error: '#C82333',   // Darker red for regency
             warning: '#E0A800', // Darker yellow for regency
             info: '#138496'     // Darker blue for regency
         };
     ...
     // Regency-specific message methods
     ...
     // Pre-defined messages untuk regency
     showCreated() {
 ...
 window.RegencyToast = RegencyToast;
